...
class ETPRelationDataset(FairseqDataset):
    ...
    def __getitem__(self, index):
        with numpy_seed('EntityPredictionDataset', self.seed, self.epoch, index):
            ...
            passage, mask_annotation_position, all_annotation_positions = self.annotated_text.annotate_mention(entity, start_pos, end_pos, start_block, end_block, return_all_annotations=True)
        ...
        item = {
            ...
            'all_annotations': torch.LongTensor(all_annotation_position),

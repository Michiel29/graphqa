...
class TripletDataset(RelInfDataset):
    ...
    def __init__(self, text_data, annotation_data, graph, k_negative, n_entities, dictionary, mask_type, assign_head_tail, shift_annotations):
        super().__init__(text_data, annotation_data, graph, k_negative, n_entities, dictionary, mask_type, assign_head_tail, shift_annotations)

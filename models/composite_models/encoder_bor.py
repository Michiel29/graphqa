...
@register_model('encoder_bor')
class EncoderBoRModel(BaseFairseqModel):
...
@register_model_architecture('encoder_bor', 'encoder_bor__roberta_base')
def bor_base_architecture(args):
    base_architecture(args)


@register_model_architecture('encoder_bor', 'encoder_bor__roberta_large')
def bor_large_architecture(args):
    large_architecture(args)


@register_model_architecture('encoder_bor', 'encoder_bor__roberta_small')
def bor_small_architecture(args):

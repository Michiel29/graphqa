...
@register_model('encoder_mtb_plus')
class EncoderMTBPlusModel(BaseFairseqModel):
...
@register_model_architecture('encoder_mtb_plus', 'encoder_mtb_plus__roberta_base')
def mtb_plus_base_architecture(args):
    base_architecture(args)


@register_model_architecture('encoder_mtb_plus', 'encoder_mtb_plus__roberta_large')
def mtb_plus_large_architecture(args):
    large_architecture(args)


@register_model_architecture('encoder_mtb_plus', 'encoder_mtb_plus__roberta_small')
def mtb_plus_small_architecture(args):

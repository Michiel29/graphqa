...
#@register_model_architecture('roberta_triplet', 'roberta')
...
#@register_model_architecture('roberta_triplet', 'roberta_base')
def roberta_base_architecture(args):
    base_architecture(args)


#@register_model_architecture('roberta_triplet', 'roberta_large')
...
#@register_model_architecture('roberta_triplet', 'xlm')

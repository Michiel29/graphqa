...
def main(args, init_distributed=False):
    ...
    for valid_sub_split in args.valid_subset.split(','):
        ...
        logger.info('beginning valid graph construction')
        task.datasets[valid_sub_split].neighbor_list, task.datasets[valid_sub_split].edge_dict = construct_graph(task.datasets[valid_sub_split].annotation_data, len(task.entity_dictionary))
        logger.info('finished valid graph construction')
